...
public class MarkdownRenderer
{
    ...
    private void InitializeStyles()
    {
        ...
        headingStyle2.fontSize = 19;
        headingStyle2.fontStyle = FontStyle.Bold;
        headingStyle2.normal.textColor = new Color(0.82f, 0.82f, 0.82f);

        headingStyle3 = new GUIStyle(bodyStyle);
        headingStyle3.fontSize = 16;
        headingStyle3.fontStyle = FontStyle.Bold;
        headingStyle3.normal.textColor = new Color(0.72f, 0.72f, 0.72f);

        headingStyle4 = new GUIStyle(bodyStyle);
        headingStyle4.fontSize = 15;
        headingStyle4.fontStyle = FontStyle.Bold;
        headingStyle4.normal.textColor = new Color(0.62f, 0.62f, 0.62f);

        headingStyle5 = new GUIStyle(bodyStyle);
        headingStyle5.fontSize = 14;
        headingStyle5.fontStyle = FontStyle.Bold;
        headingStyle5.normal.textColor = new Color(0.52f, 0.52f, 0.52f);

        headingStyle6 = new GUIStyle(bodyStyle);
        headingStyle6.fontSize = 12;
        headingStyle6.fontStyle = FontStyle.Bold;
        headingStyle6.normal.textColor = new Color(0.42f, 0.42f, 0.42f);

        linkStyle = new GUIStyle(bodyStyle);
        linkStyle.normal.textColor = new Color(0x00 / 255f, 0x88 / 255f, 0xDA / 255f, 1f);
        linkStyle.hover.textColor = new Color(0x00 / 255f, 0x88 / 255f, 0xDA / 255f, 0.8f);
